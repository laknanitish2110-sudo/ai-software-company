...
> = {
  ceo: {
    ...
    icon: "👨‍💼",
    color: "#6366f1",
    description: "Understands the problem, plans the product",
  },
  business_analyst: {
    label: "Business Analyst",
    icon: "📋",
    color: "#10b981",
    description: "Defines requirements and user needs",
  },
  researcher: {
    label: "Researcher",
    icon: "🔍",
    color: "#f59e0b",
    description: "Investigates market and best practices",
  },
  architect: {
    label: "Solution Architect",
    icon: "🏗️",
    color: "#8b5cf6",
    description: "Designs the system and tech stack",
  },
  engineer: {
    label: "Software Engineer",
    icon: "💻",
    color: "#ef4444",
    description: "Builds the working product",
  },
  ppt: {
    label: "Presenter",
    icon: "📊",
    color: "#06b6d4",
    description: "Creates documentation and pitch materials",
  },
};
...
export const STATUS_LABELS: Record<string, string> = {
  created: "Understanding your problem...",
  ba_working: "Defining requirements...",
  ba_review: "Review: Requirements",
  research_working: "Researching market & tools...",
  research_review: "Review: Research",
  architect_working: "Designing system...",
  architect_review: "Review: Architecture",
  engineer_working: "Building your product...",
  engineer_review: "Review: Implementation",
  ppt_working: "Preparing deliverables...",
  completed: "Product Ready",
  paused: "Paused",
};
